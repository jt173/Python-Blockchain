...
def sha256(message: bytearray) -> bytearray:
    ...
    # The argument should be bytes, bytearray, or string object
    ...
    # Padding
    length = len(message) * 8 # len(message) is the number of bytes
    message.append(0x80)
    ...
    for message_block in blocks:
        ...
        for t in range(0, 64):
            if t <= 15:
                ...
                # starting from the leftmost word
                # 4 bytes at a time
